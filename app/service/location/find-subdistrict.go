...
func (svc *locationService) FindSubdistrict(ctx *fiber.Ctx) (*model.Response, error) {
	// TODO: implement me
	...
	category := new(subdistricts.Subdistrict)
	result := svc.SubdistrictRepo.Find(category, map[string]any{"code": payload.Code})
