...
func (svc *locationService) FindCity(ctx *fiber.Ctx) (*model.Response, error) {
	// TODO: implement me
	...
	category := new(cities.City)
	result := svc.CityRepo.Find(category, map[string]any{"code": payload.Code})
